...
func _ready():
	...
	if(mapa != null):
		...
		controlaFases.set_numero_fase_atual(3)
		controlaFases.set_fase_atual(preload("res://prototipo2/labirintos/prototipal/fases/faseTesteEletrica.scn"))
		controlaFases.set_proxima_fase(preload("res://prototipo2/labirintos/prototipal/fases/faseTeste.scn"))
		controlaFases.set_tela_vitoria(preload("res://prototipo2/telas/vitoriaFinal.scn"))
